...
def transformer_encoder(inputs, bias, src_mask, params, dtype=None, scope=None):
    with tf.variable_scope(scope, default_name="encoder", dtype=dtype,
        ...
        #[batch, src_len, hid_size] --> [batch, 1, hid_size]
...
def encoding_graph(features, mode, params):
    ...
    encoder_output = transformer_encoder(encoder_input, enc_attn_bias, src_mask, params)
